...
const useDomMapping = (element, options = {}) => {
  const { top, left, width: elWidth, height: elHeight, bottom, update, x, y } = useElementBounding(element, {})
  ...
  const position = useMemo(() => {
    ...
    return { x: 0, y: 0, z: 0 }
  }, [camera, cameraSize, left, options.value, scale.x, scale.y, top, screenWidth, screenHeight])
